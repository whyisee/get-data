	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="nav-click <#if pageName == "jobflow">active</#if>" ><a href="${request.contextPath}/jobflow"><i class="fa fa-circle-o text-gray"></i><span>${I18n.jobflow_name}</span></a></li>
